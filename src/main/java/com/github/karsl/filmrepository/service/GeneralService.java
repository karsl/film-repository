...
public interface GeneralService {
    ...
    /**
     * Returns registered (currently present in the database) languages. Each of these languages is the language of one
     * or many films.
     *
    ...
    /**
     * Returns registered (currently present in the database) film genres. Each of these genres is the genre of one or
     * many films.
     *
    ...
    /**
     * Assuming the passed film object's languages', media's, genre's ID fields and credits' full name has been set,
     * fills the rest of their fields (e.g. language name, media name) according to the IDs and credits' full name.
     *
    ...
    /**
     * Updates a film's credits by removing credits if they don't participate anymore or adding new credits.
     * <p>
     * When a new credit is added, a new actor is also added if the actor is new too.
