...
/**
 * I was not willing to employ REST service for this service, however deletion of a film matches with REST
 * 'pattern' so deletion functionality is provided via REST controller. Also, maybe in the future I could add a total
 * REST service.
 */
@RestController
